...
<body style="margin:0;padding:0;background:#f7f5f0;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:20px;">
    ...
    <div style="padding:40px 30px;text-align:center;background:#fff;border-radius:0 0 12px 12px;">
      ...
      <!-- CTA -->
      <a href="https://worldwideshades.com/recover/${cart.id}?utm_source=email&utm_medium=recovery&utm_campaign=abandoned_cart&utm_content=email${emailNum}" style="display:inline-block;padding:16px 40px;background:linear-gradient(135deg,#c8a165,#b8895a);color:#fff;text-decoration:none;border-radius:8px;font-size:16px;font-weight:700;letter-spacing:0.5px;">
        Complete Your Order →
      </a>
