      ...
      <div className={styles.measSection}>
        ...
        <div className={styles.measRow}>
          <div className={styles.measDiagram}>
            <img
              src="https://res.cloudinary.com/dcmlcfynd/image/upload/c_crop,g_center,w_550,h_420,y_30/w_400,q_auto,f_auto/v1764525899/Bottom_up_rectangle_jvenzj.webp"
      ...
      {showMeasureGuide && (
        <div className={styles.overlay} onClick={() => setShowMeasureGuide(false)}>
          <div className={styles.overlayContent} onClick={(e) => e.stopPropagation()}>
            ...
            <img
              src="https://res.cloudinary.com/dcmlcfynd/image/upload/c_crop,g_center,w_550,h_420,y_30/w_800,q_auto,f_auto/v1764525899/Bottom_up_rectangle_jvenzj.webp"
