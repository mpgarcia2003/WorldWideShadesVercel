...
const translations = {
  en: {
    ...
    "step.1.desc": "Select your shade type and fabric",
    "step.2": "Shape & Size",
    "step.3": "Installation Style",
    "step.4": "Control Type",
    ...
    "pro.diyWarning": "We'll review your measurements before production.",
    "pro.serviceAreaCheck": "Check Service Area",
    "pro.zipPlaceholder": "Enter Zip Code",
    "pro.handleMyself": "Measure It Myself",
    "pro.diyDesc": "I'll follow your simple guide — takes ~2 minutes",
    "pro.getHelp": "Have a Pro Handle It",
    ...
    "shadeType.lightFilteringDesc": "Softens sunlight while maintaining your view and natural brightness",
    "shadeType.blackout": "Blackout",
    "shadeType.blackoutDesc": "Blocks 99%+ of light — ideal for bedrooms, nurseries & media rooms. For 100% blackout, add Light Blocking Side Channels in Finish Options.",
    "shadeType.all": "All Fabrics",
    "shadeType.allDesc": "Browse our complete collection of both types",
    "fabric.selectMaterial": "Select Material",
    "mount.inside": "Inside Mount",
    "mount.outside": "Outside Mount",
    "mount.clothSize": "Cloth Size",
    "mount.clothSizeDesc": "Specify exact fabric width",
    "mount.clothSizeNote": "We'll cut your fabric to the exact width you enter. Note: with brackets and hardware, the total shade will be approximately 1½\" wider than the fabric.",
    "control.chain": "Metal Chain",
    "control.chainDesc": "Manual bead chain control — simple, reliable, no power needed. Includes a child-safety clip for added protection. Best for easy-reach windows.",
    "control.motorized": "Motorized",
    "control.motorizedDesc": "Remote or app-controlled with whisper-quiet operation. Perfect for hard-to-reach or large windows.",
    "control.rechargeable": "Rechargeable",
    "control.hardwired": "Hardwired",
    "control.remote": "Remote Control",
    "control.remoteDesc": "Control your shades from anywhere in the room. Each remote controls up to 5 shades.",
    ...
    "control.chargerDesc": "We recommend one charger per household. Your shades only need charging 2–3 times per year. Comes with a 15ft cord.",
    "control.appDesc": "Control via smartphone app.",
    "valance.standard": "Standard Roll",
    "valance.reverse": "Reverse Roll",
    "valance.cassette": "Cassette",
    "valance.fascia": "Metal Fascia",
    "valance.cassetteInsertOffer": "Matching fabric insert available at no extra charge",
    "valance.cassetteInsertWith": "With Fabric Insert",
    "valance.cassetteInsertWithout": "No Fabric Insert",
    "valance.cassetteInsertWithDesc": "Cassette wrapped in matching shade fabric",
    "valance.cassetteInsertWithoutDesc": "Plain cassette — no fabric wrap",
    ...
    "actions.langCode": "ES",
    "sale.banner": "Spring Into Shade Sale — Up to 50% Off",
    "sale.badge": "50% OFF",
    "sale.ends": "Sale ends April 30",
    "sale.reason": "Spring Into Shade Sale",
    "sale.originalPrice": "Regular Price",
    "sale.salePrice": "Sale Price",
    "freight.title": "Oversize Shade — Freight Required",
    "freight.message": "Shades wider than 108\" can't fit in FedEx and must ship via freight (+$475). The freight charge will be added to your total.",
    "freight.lineLabel": "Freight Shipping (oversize)"
  },
  es: {
    ...
    "step.1": "Elige Tu Tela",
    "step.1.desc": "Selecciona tipo y tela",
    "step.2": "Forma y Tamaño",
    "step.3": "Estilo de Instalación",
    "step.4": "Tipo de Control",
    "step.5": "Personalizar Look",
    "step.6": "Cantidad",
    ...
    "pro.handleMyself": "Medir Yo Mismo",
    "pro.diyDesc": "Seguiré su guía simple — toma ~2 minutos",
    "pro.getHelp": "Que un Profesional lo Haga",
    ...
    "shadeType.lightFilteringDesc": "Suaviza la luz solar manteniendo la vista y la luminosidad natural",
    "shadeType.blackout": "Opaco (Blackout)",
    "shadeType.blackoutDesc": "Bloquea el 99%+ de la luz — ideal para dormitorios, guarderías y salas multimedia. Para oscurecimiento total, agregue Canales Laterales en Opciones de Acabado.",
    "shadeType.all": "Todas las Telas",
    "shadeType.allDesc": "Explore nuestra colección completa de ambos tipos",
    "fabric.selectMaterial": "Seleccionar Material",
    "mount.inside": "Montaje Interior",
    "mount.outside": "Montaje Exterior",
    "mount.clothSize": "Tamaño de Tela",
    "mount.clothSizeDesc": "Especifique el ancho exacto de la tela",
    "mount.clothSizeNote": "Cortaremos su tela al ancho exacto que ingrese. Nota: con los soportes y herrajes, la cortina total será aproximadamente 1½\" más ancha que la tela.",
    "control.chain": "Cadena de Metal",
    "control.chainDesc": "Control manual con cadena — simple, confiable, sin electricidad. Incluye clip de seguridad infantil. Ideal para ventanas de fácil acceso.",
    "control.motorized": "Motorizado",
    "control.motorizedDesc": "Control remoto o por app con operación silenciosa. Perfecto para ventanas altas o de difícil acceso.",
    "control.rechargeable": "Recargable",
    "control.hardwired": "Cableado",
    "control.remote": "Control Remoto",
    "control.remoteDesc": "Controle sus cortinas desde cualquier lugar de la habitación. Cada control remoto controla hasta 5 cortinas.",
    ...
    "control.chargerDesc": "Recomendamos un cargador por hogar. Sus cortinas solo necesitan cargarse 2–3 veces al año. Incluye un cable de 15 pies.",
    ...
    "valance.cassetteInsertOffer": "Inserto de tela a juego disponible sin cargo adicional",
    "valance.cassetteInsertWith": "Con Inserto de Tela",
    "valance.cassetteInsertWithout": "Sin Inserto de Tela",
    "valance.cassetteInsertWithDesc": "Cassette envuelto en la tela de la cortina",
    "valance.cassetteInsertWithoutDesc": "Cassette simple — sin envoltura de tela",
    ...
    "actions.langCode": "EN",
    "sale.banner": "Venta de Primavera — Hasta 50% de Descuento",
    "sale.badge": "50% DESC.",
    "sale.ends": "La oferta termina el 30 de abril",
    "sale.reason": "Venta de Primavera",
    "sale.originalPrice": "Precio Regular",
    "sale.salePrice": "Precio de Oferta",
    "freight.title": "Cortina de Gran Tamaño — Envío por Carga Requerido",
    "freight.message": "Las cortinas de más de 108\" no caben en FedEx y deben enviarse por carga (+$475). El cargo de envío se agregará a su total.",
    "freight.lineLabel": "Envío por Carga (gran tamaño)"
  }
};
