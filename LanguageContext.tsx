...
const translations = {
  en: {
    ...
    "actions.langCode": "ES",
    "sale.banner": "Spring Into Shade Sale — Up to 40% Off",
    "sale.badge": "40% OFF",
    "sale.ends": "Limited time offer",
  ...
  es: {
    ...
    "actions.langCode": "EN",
    "sale.banner": "Venta de Primavera — Hasta 40% de Descuento",
    "sale.badge": "40% DESC.",
    "sale.ends": "Oferta por tiempo limitado",
