...
const translations = {
  en: {
    ...
    "step.1": "Window Shape",
    "step.1.desc": "What shape is your window?",
    "step.2": "Measurements",
    "step.3": "Shade Type",
    "step.4": "Choose Your Color & Finish",
    "step.5": "Installation Style",
    "step.6": "Control Type",
    "step.7": "Customize Look",
    "step.8": "Quantity",
    "step.prefix": "Step",
  ...
  es: {
    ...
    "step.1": "Forma de Ventana",
    "step.1.desc": "¿Cuál es la forma de su ventana?",
    "step.2": "Mediciones",
    "step.3": "Tipo de Cortina",
    "step.4": "Elige Tu Color y Acabado",
    "step.5": "Estilo de Instalación",
    "step.6": "Tipo de Control",
    "step.7": "Personalizar Look",
    "step.8": "Cantidad",
    "step.prefix": "Paso",
