...
const translations = {
  en: {
    ...
    "step.1": "Shape & Size",
    "step.1.desc": "Shape and measurements",
    "step.2": "Shade Type",
    "step.3": "Choose Your Color & Finish",
  ...
  es: {
    ...
    "step.1": "Forma y Tamaño",
    "step.1.desc": "Forma y medidas",
    "step.2": "Tipo de Cortina",
    "step.3": "Elige Tu Color y Acabado",
    "step.4": "Estilo de Instalación",
    "step.5": "Tipo de Control",
    "step.6": "Personalizar Look",
    "step.7": "Cantidad",
    "step.prefix": "Paso",
